<template>
  <div class="flex">
    ...
    <div
      ...
      @click="isOpen = false"
      class="fixed inset-0 z-20 transition-opacity bg-blue opacity-50 lg:hidden"
    ></div>
    <!-- End Backdrop -->
    ...
    >
      ...
      <nav class="mt-10">
        <router-link
          ...
          :class="[$route.name === 'Reservas' ? activeClass : inactiveClass]"
          to="/"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[
            $route.name === 'EstadoCuenta' ? activeClass : inactiveClass,
          ]"
          to="/estado-cuenta"
        >
          ...
          <span class="mx-4">Estado de cuenta</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[
            $route.name === 'ConfiguracionCuenta' ? activeClass : inactiveClass,
          ]"
        ...
        >
          ...
          <span class="mx-4">Configuracion de la cuenta</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Ayuda' ? activeClass : inactiveClass]"
          to="/ayuda"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
